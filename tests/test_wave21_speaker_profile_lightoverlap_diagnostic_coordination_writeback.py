...
from src.wave21_speaker_profile_lightoverlap_diagnostic_coordination_writeback import (
...
class Wave21SpeakerProfileLightOverlapDiagnosticCoordinationWritebackTest(unittest.TestCase):
    ...
    def test_run_coordination_writeback_requires_wave21_closure(self) -> None:
        with patch(
            "src.wave21_speaker_profile_lightoverlap_diagnostic_coordination_writeback.load_json_dict",
            side_effect=[
