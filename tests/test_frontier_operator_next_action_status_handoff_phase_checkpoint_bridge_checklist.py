...
class FrontierOperatorNextActionStatusHandoffPhaseCheckpointBridgeChecklistTest(unittest.TestCase):
    def test_build_bridge_checklist_rows_links_checkpoint_to_milestone(self) -> None:
        ...
        self.assertIn("status_handoff_milestone_card.md", rows[0]["receipt_target"])
        self.assertIn("ready_lane verification is complete", rows[0]["bridge_note"])
