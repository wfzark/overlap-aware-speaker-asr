...
class FrontierExecutionQueueHandoffPacketTest(unittest.TestCase):
    def test_build_packet_rows_include_thirteen_sections(self) -> None:
        ...
        self.assertEqual(rows[11]["section_name"], "execution_queue_completion_dashboard_bridge_checklist")
