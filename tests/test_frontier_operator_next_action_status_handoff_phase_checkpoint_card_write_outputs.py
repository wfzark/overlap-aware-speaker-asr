...
from src.frontier_operator_next_action_status_handoff_phase_checkpoint_card import (
...
class FrontierOperatorNextActionStatusHandoffPhaseCheckpointCardWriteOutputsTest(unittest.TestCase):
    def test_write_outputs_emits_csv_json_and_markdown(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            root = Path(tmp_dir)
            with patch(
                "src.frontier_operator_next_action_status_handoff_phase_checkpoint_card.PROJECT_ROOT",
                root,
            ):
            ...
            self.assertEqual(payload["completion_signal"], "ready_lane verification is complete")
