...
from src.frontier_execution_receipt_fill_execution_frontier_bridge import (
...
class FrontierExecutionReceiptFillExecutionFrontierBridgeWriteOutputsTest(unittest.TestCase):
    def test_write_outputs_emits_csv_json_and_markdown(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            root = Path(tmp_dir)
            with patch(
                "src.frontier_execution_receipt_fill_execution_frontier_bridge.PROJECT_ROOT",
                root,
            ):
            ...
            with csv_path.open("r", encoding="utf-8-sig", newline="") as handle:
                ...
                self.assertEqual(list(reader)[0]["fill_execution_frontier"], "meeteval_compatibility")
