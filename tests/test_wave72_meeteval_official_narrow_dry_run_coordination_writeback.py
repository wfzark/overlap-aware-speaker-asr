...
from src.wave72_meeteval_official_narrow_dry_run_coordination_writeback import (
...
class Wave66MeetevalOfficialNarrowDryRunCoordinationWritebackTest(unittest.TestCase):
    ...
    def test_build_fill_row_marks_wave72_official_coordination_complete(self) -> None:
    ...
    def test_run_coordination_writeback_requires_wave72_closure(self) -> None:
        with patch(
            "src.wave72_meeteval_official_narrow_dry_run_coordination_writeback.load_json_dict",
            side_effect=[
