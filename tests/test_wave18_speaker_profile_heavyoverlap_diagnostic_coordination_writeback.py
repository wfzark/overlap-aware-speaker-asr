...
from src.wave18_speaker_profile_heavyoverlap_diagnostic_coordination_writeback import (
...
class Wave18SpeakerProfileHeavyOverlapDiagnosticCoordinationWritebackTest(unittest.TestCase):
    ...
    def test_run_coordination_writeback_requires_wave18_closure(self) -> None:
        with patch(
            "src.wave18_speaker_profile_heavyoverlap_diagnostic_coordination_writeback.load_json_dict",
            side_effect=[
