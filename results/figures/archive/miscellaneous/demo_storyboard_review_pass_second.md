...
| --- | --- | --- | --- | --- | --- |
| 2 | 2 | Pipeline | review_complete | Qualitative storyboard review for card 2 (Pipeline) complete; no live demo or recording is claimed. | results/tables/demo_storyboard_receipt.json |
