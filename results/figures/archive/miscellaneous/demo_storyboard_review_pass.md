...
| --- | --- | --- | --- | --- | --- |
| 1 | 1 | Problem | review_complete | Qualitative storyboard review for card 1 (Problem) complete; no live demo or recording is claimed. | results/tables/demo_storyboard_receipt.json |
