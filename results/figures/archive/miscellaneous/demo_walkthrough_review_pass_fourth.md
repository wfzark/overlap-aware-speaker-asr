...
| --- | --- | --- | --- | --- | --- |
| 4 | 4 | Frontier breadth | review_complete | Qualitative walkthrough review for 4 complete; no live demo or recording is claimed. | results/tables/demo_walkthrough_receipt.json |
