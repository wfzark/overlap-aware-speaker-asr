...
| --- | ---: | ---: | ---: | --- | --- | --- | --- | --- |
| frontier_go_no_go_board | 5 | 4 | 1 | meeteval_compatibility | external_validation | mixed_ready_state | meeteval_compatibility | Top-level coordination board only; it summarizes narrow next-step readiness without claiming frontier completion. |
