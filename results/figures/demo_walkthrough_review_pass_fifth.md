...
| --- | --- | --- | --- | --- | --- |
| 5 | 5 | Next-step framing | review_complete | Qualitative walkthrough review for 5 complete; no live demo or recording is claimed. | results/tables/demo_walkthrough_receipt.json |
