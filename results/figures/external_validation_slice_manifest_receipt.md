...
| --- | --- | --- | --- | --- |
| manifest_complete | single_short_meeting_excerpt | AISHELL-4 | blocked_by_license_gate | Slice manifest documented; external audio staging remains blocked until license confirmation is recorded. |
