...
| demo_excellence | presentation_wave6_extension_complete | none_documented | go | Wave6 presentation extension complete; README/UI refresh remains qualitative/demo only. | results/figures/demo_go_no_go_summary.md |
