# Plan: Frontier Operator Next-Action Status Handoff Completion Dashboard Bridge Checklist

1. Add a focused failing unit test for the bridge checklist row builder.
2. Implement `src/frontier_operator_next_action_status_handoff_completion_dashboard_bridge_checklist.py` using the existing completion dashboard JSON only.
